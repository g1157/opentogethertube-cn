...
export default {
	...
	room: {
		...
		upscale: {
			...
			strength: "锐化强度",
			scale: "渲染倍率",
			"scale-auto": "自动（贴合显示，不低于原分辨率）",
			"scale-hint":
				"自动按显示尺寸取倍率，且不会低于原分辨率。大屏上更高倍率更锐利、也更耗电；设备吃力时调低可明显省性能。",
	...
	help: {
		...
		add: {
			...
			items: {
				...
				bilibili: "B 站视频（支持 BV/av 号、分 P 与 b23.tv 短链；外链播放器无法被程序控制，切换视频与进入房间时会对齐，播放中各观众自主控制，进度不做强制同步）",
			},
